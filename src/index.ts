import {IAuthor, Ratingable} from './interfaces'
...
export class Book {
    ...
    constructor(name: string, genre: string, price: number | null, author?: IAuthor, reviews?: [string, number, string][]) {
        this.name = name;
        this.genre = genre;
        this.price = price;
    }
...
const printBookName = (book: IBook) => console.log(book.name);
